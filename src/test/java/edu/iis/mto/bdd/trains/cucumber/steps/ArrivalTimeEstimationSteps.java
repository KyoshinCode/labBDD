...
public class ArrivalTimeEstimationSteps {
    ...
    public void chcę_się_dostać_z_Parramatta_do_TownHall() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }

    @Zakładając("^następny pociąg odjeżdża o (\\d+):(\\d+) na linii Western$")
    public void następny_pociąg_odjeżdża_o_na_linii_Western(int arg1, int arg2) throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }
